...
endMembers = zeros(N(3), maxComponents);  % containes spectra of those maxComponents ASE components
organList = zeros(N(1), N(2), maxComponents); % containes images of the ASE components

cube1 = cube;

h = waitbar(0, 'Calculating ASE components ...');
