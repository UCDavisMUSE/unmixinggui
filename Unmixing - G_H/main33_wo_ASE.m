function varargout = main33_wo_ASE(varargin)
% MAIN33_WO_ASE M-file for main33_wo_ASE.fig
%      MAIN33_WO_ASE, by itself, creates a new MAIN33_WO_ASE or raises the existing
%      singleton*.
%
%      H = MAIN33_WO_ASE returns the handle to a new MAIN33_WO_ASE or the handle to
%      the existing singleton*.
%
%      MAIN33_WO_ASE('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in MAIN33_WO_ASE.M with the given input arguments.
%
%      MAIN33_WO_ASE('Property','Value',...) creates a new MAIN33_WO_ASE or raises the
%      existing singleton*.  Starting from the left, property value pairs
%      are
%      applied to the GUI before main33_wo_ASE_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to main33_wo_ASE_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help main33_wo_ASE

% Last Modified by GUIDE v2.5 18-Jan-2011 00:54:18

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @main33_wo_ASE_OpeningFcn, ...
                   'gui_OutputFcn',  @main33_wo_ASE_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before main33_wo_ASE is made visible.
function main33_wo_ASE_OpeningFcn(hObject, eventdata, handles, varargin)
...
% Choose default command line output for main33_wo_ASE
function varargout = main33_wo_ASE_OutputFcn(hObject, eventdata, handles)
