function varargout = main32_w_ASE(varargin)
% MAIN32_W_ASE M-file for main32_w_ASE.fig
%      MAIN32_W_ASE, by itself, creates a new MAIN32_W_ASE or raises the existing
%      singleton*.
%
%      H = MAIN32_W_ASE returns the handle to a new MAIN32_W_ASE or the handle to
%      the existing singleton*.
%
%      MAIN32_W_ASE('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in MAIN32_W_ASE.M with the given input arguments.
%
%      MAIN32_W_ASE('Property','Value',...) creates a new MAIN32_W_ASE or raises the
%      existing singleton*.  Starting from the left, property value pairs
%      are
%      applied to the GUI before main32_w_ASE_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to main32_w_ASE_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help main32_w_ASE

% Last Modified by GUIDE v2.5 12-Jan-2011 01:16:20

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @main32_w_ASE_OpeningFcn, ...
                   'gui_OutputFcn',  @main32_w_ASE_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before main32_w_ASE is made visible.
function main32_w_ASE_OpeningFcn(hObject, eventdata, handles, varargin)
...
% Choose default command line output for main32_w_ASE
function varargout = main32_w_ASE_OutputFcn(hObject, eventdata, handles)
