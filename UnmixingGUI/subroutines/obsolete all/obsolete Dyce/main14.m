function varargout = main14(varargin)
% MAIN14 M-file for main14.fig
%      MAIN14, by itself, creates a new MAIN14 or raises the existing
%      singleton*.
%
%      H = MAIN14 returns the handle to a new MAIN14 or the handle to
%      the existing singleton*.
%
%      MAIN14('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in MAIN14.M with the given input arguments.
%
%      MAIN14('Property','Value',...) creates a new MAIN14 or raises the
%      existing singleton*.  Starting from the leftFrame, property value pairs are
%      applied to the GUI before main14_OpeningFunction gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to main14_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help main14

% Last Modified by GUIDE v2.5 01-Aug-2008 13:43:42

% Begin initialization code - DO NOT EDIT
gui_Singleton = 0;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @main14_OpeningFcn, ...
                   'gui_OutputFcn',  @main14_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before main14 is made visible.
function main14_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to main14 (see VARARGIN)

% Choose default command line output for main14
...
% UIWAIT makes main14 wait for user response (see UIRESUME)
% uiwait(handles.figure1);

% --- Outputs from this function are returned to the command line.
function varargout = main14_OutputFcn(hObject, eventdata, handles) 
...
switch value 
    case 1
        plot(handles.organs(organIndex).array);
    case 2
        plot(handles.organs(organIndex).derivarray);
    case 3
        plot(handles.organs(organIndex).deriv2array);
    case 4
        plot(handles.organs(organIndex).concatarray);
end
