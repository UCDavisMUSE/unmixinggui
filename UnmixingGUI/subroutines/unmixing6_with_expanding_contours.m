...
%                 size(spectrum)
                ...
                if SpectrumDistinctiveEnough(spectrum, insideSpectrum,0.1)
...
Pos(3); plot(NormalizeSpectra(finalSpectra)); title(['Average mag = ' num2str(averageMag) ', Average offset = ' num2str(averageOffset)]);
Composite(FindCoeff( finalSpectra, x, 1), MyTitle, 0.4, [2 2]);
