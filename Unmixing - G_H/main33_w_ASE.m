function varargout = main33_w_ASE(varargin)
% MAIN33_W_ASE M-file for main33_w_ASE.fig
...
%      are
%      applied to the GUI before main33_w_ASE_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to main33_w_ASE_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help main33_w_ASE
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @main33_w_ASE_OpeningFcn, ...
                   'gui_OutputFcn',  @main33_w_ASE_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before main33_w_ASE is made visible.
function main33_w_ASE_OpeningFcn(hObject, eventdata, handles, varargin)
...
% Choose default command line output for main33_w_ASE
function varargout = main33_w_ASE_OutputFcn(hObject, eventdata, handles)
