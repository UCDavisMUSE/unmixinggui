...
numberOfBoxes = 3;
trueS = zeros(n,1);
[box1, trueS(:,1)] = span(100*makeb(N,10,10,10),0.1*n,0.3*n);
[box2, trueS(:,2)] = span(200*makeb(N,10,15,14),0.2*n,0.5*n);
[box3, trueS(:,3)] = span(150*makeb(N,10,17,17),0.5*n,0.7*n);
